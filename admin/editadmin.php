        ...
        <div class="box">
          ...
          <div class="box box-primary">
            ...
            <?php foreach ($user as $u) { ?>
              ...
              <form role="form" method="post" action="proseseditadmin.php" enctype="multipart/form-data">
                <input type="hidden" value="<?= $u['id']; ?>" name="id">
                <div class="box-body">
                  <div class="form-group">
                    <label>Username</label>
                    <input type="text" name="username" class="form-control" id="username" value="<?= $u['username']; ?>" required readonly >
                  </div>
                  <div class="form-group">
