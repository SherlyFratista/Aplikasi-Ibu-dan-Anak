...
$name = $_SESSION['name']; 
$artikel = query("SELECT * FROM artikel_informasi");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Lihat Artikel Informasi</title>
              ...
              <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="contact-delete">
                        <form action='editartikelinformasi.php?id="<?php echo $row['id']; ?>"' method="post">
                    ...
                    <td class="contact-delete">
                        <form action='prosesdeleteartikelinformasi.php?id="<?php echo $row['id']; ?>"' method="post">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
