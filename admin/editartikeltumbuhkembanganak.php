...
$name = $_SESSION['name']; 
$id = $_POST['id'];
$artikel = query("SELECT * FROM artikel_TumbuhKembangAnak where id = '$id'");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Edit Artikel Tumbuh Kembang Anak</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Artikel Tumbuh Kembang Anak
      </h1>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- form start -->
            <form role="form" method="post" action="proseseditartikeltumbuhkembanganak.php" enctype="multipart/form-data"">
              <div class="box-body">
